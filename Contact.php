...
<html lang="en">
    ...
    <body>
        ...
        <main class="main">
            ...
            <!--========= DESCRIPTION ===========-->
            <section class="desc section" id="">
                <div class="desc__container container grid">
                    <div class="desc__content">
                        <div class="desc__data">
                            <span class="desc__subtitle">For technocal support, please check the</span>
                        </div>
                    ...
                    <div class="desc__address">
                        ...
                        <p class="desc__description">
                            Housell, Inc. <br>
                            887-5655-4455 <br>
                            1302 Second Avenue, Floor 31 <br>
                            Seattle, WA 98181. <br>
                        </p>
                    </div>
                </div>
